...
# -*- coding: utf-8 -*-
'''
keras_cnn_example_functional_api.py
...
in Keras to predict if images from the CIFAR10 dataset belong to one often
classes/categories. For more details on Keras' CNN implementation see:
...
from tensorflow.keras import ### WHAT DO WE NEED FOR THE FUNCTIONAL API?
...
x = ### pass in your inputs and do your actual work here   
  
cifar_output = ### set final network output (10 classes)
